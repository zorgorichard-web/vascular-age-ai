...
# --- UI STÍLUS (Javítva: Tiszta HTML/CSS struktúra) ---
st.markdown("""
    <style>
    ...
    /* Pecsét pozicionálása - Nem takarja el a szöveget de ott van */
    .stamp-img { 
        position: absolute; 
        bottom: 20px; 
        right: 140px; 
...
if st.button("KLINIKAI JELENTÉS GENERÁLÁSA"):
    ...
    with st.spinner('Jakab professzor elemzi az adatokat...'):
        ...
        Érrendszeri kora: {v_age} év. 
        Írj egy nyers, sürgető, tekintélyes orvosi diagnózist magyarul. 
        Említsd a 6,1 kg lerakódást az erekben és a Cardiotensive megoldást. 
        Használj rövid, ütős mondatokat.
        """
        ...
        try:
            ...
            # --- A JAVÍTOTT PROFESSZORI KÁRTYA ---
            # Itt egyetlen f-stringbe raktuk a HTML-t, hogy ne törjön el.
            html_lelet = f"""
            <div class='prof-card'>
